# Cursor Server support in NixOS
...
{
  imports = [
    (fetchTarball "https://github.com/nix-community/nixos-cursor-server/tarball/master")
  ];
...
```nix
{
  inputs.cursor-server.url = "github:nix-community/nixos-cursor-server";
